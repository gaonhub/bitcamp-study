...
public class App {
  ...
  static void processBoardList() {
    ...
    java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("yyyy-MM-dd hh:mm:ss"); // hh:mm:ss (시간:분:초)
  ...
  static int promptMenu() {
    ...
    return menuNo; or return Integer.parseInt(input);
    */
